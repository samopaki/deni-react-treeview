...
var DeniReactTreeView = function (_React$Component) {
  ...
  function DeniReactTreeView(props) {
    ...
    _this.expandAllFinished = _this.expandAllFinished.bind(_this);
    return _this;
  }
  ...
  _createClass(DeniReactTreeView, [{
    ...
    key: 'expandAllFinished',
    value: function expandAllFinished() {
...
function _createComponentsChildren(treeview, parent, level, children) {
  var expandAll = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  ...
  return _react2.default.createElement(
    ...
    parent.props.item && parent.props.item.expanded && children && children.length ? children.map(function (child) {
      var domTreeviewItem = _react2.default.createElement(_deniReactTreeviewItem2.default, { expandAll: expandAll, treeview: treeview, parent: parent, level: level, key: child.id, item: child });
      return _react2.default.createElement(
        'div',
        { key: child.id },
        domTreeviewItem,
  ...
  _createClass(ActionButtons, [{
    ...
    value: function render() {
      ...
      this.props.buttons.map(function (actionButton, index) {
        ...
        } else if (actionButton.props['disabled-on-folder'] === 'true' && _this2.props.item.isLeaf) {
          actionButtons.push(_react2.default.createElement(
            'span',
            { key: index, className: 'action-button', onClick: _this2.props.onActionButtonClick.bind(_this2, _this2.props.item, actionButton) },
            actionButton
...
module.exports = function (scope) {
  ...
  return {
    ...
    expandAll: function expandAll() {
      _deniReactTreeviewApi2.default.expandAll(scope);
    },
    //
    // folderToFind can be passed as a "id" or as a "object" ex:
    //
...
module.exports = {
  ...
  expandAll: function expandAll(scope) {
